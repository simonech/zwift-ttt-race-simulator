...
---  
        ...
        <div class="notice">
            <p>⚠️ <strong>This is still a work in progress</strong></p>
        </div>

        <section id="motivation">
            <h2>🚴 Motivation</h2>
            <p>Team Time Trial racing is not just about FTP — it's about:</p>
            <ul>
        ...
        <section id="license">
            <h2>📄 License</h2>
            <p>This project is licensed under the MIT License – see the <a href="https://github.com/simonech/zwift-ttt-race-simulator/blob/main/LICENSE">LICENSE</a> file for details.</p>
        </section>